...
export class BusinessDataTransformations {
   ...
   */
  static transformToCRM(business: BusinessRecord, platform: 'salesforce' | 'hubspot' | 'pipedrive'): any {
    switch (platform) {
      case 'salesforce':
   ...
   */
  static transformToEmailMarketing(business: BusinessRecord, platform: 'mailchimp' | 'constant-contact'): any {
    switch (platform) {
      case 'mailchimp':
  ...
  private static estimateRevenue(business: BusinessRecord): string {
    ...
    const hasCompleteAddress = !!(business.address?.street && business.address?.city && business.address?.state)
  ...
  return [
    {
      ...
      inputTypes: ['object'],
      outputType: 'object',
      transform: (input: BusinessRecord) => BusinessDataTransformations.transformToCRM(input, 'salesforce')
    },
    {
      ...
      inputTypes: ['object'],
      outputType: 'object',
      transform: (input: BusinessRecord) => BusinessDataTransformations.transformToCRM(input, 'hubspot')
    },
    {
      ...
      inputTypes: ['object'],
      outputType: 'object',
      transform: (input: BusinessRecord) => BusinessDataTransformations.transformToCRM(input, 'pipedrive')
    },
    {
      ...
      inputTypes: ['object'],
      outputType: 'object',
      transform: (input: BusinessRecord) => BusinessDataTransformations.transformToEmailMarketing(input, 'mailchimp')
    },
    {
      ...
      inputTypes: ['object'],
      outputType: 'object',
      transform: (input: BusinessRecord) => BusinessDataTransformations.transformToEmailMarketing(input, 'constant-contact')
    }
  ]
}
