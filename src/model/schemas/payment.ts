...
export const subscriptionPlanSchema = z.object({
  ...
  description: z.string()
    .optional()
    .describe('Optional description of the plan features'),
  ...
  features: z.array(
    z.string().min(1, 'Feature description cannot be empty')
  ...
  createdAt: z.date()
    .describe('When this plan was created')
}).strict()
...
export const userSubscriptionSchema = z.object({
  ...
  currentPeriodStart: z.date()
    .describe('Start date of the current billing period'),
  
  currentPeriodEnd: z.date()
    .describe('End date of the current billing period'),
  ...
  createdAt: z.date()
    .describe('When this subscription was created'),
  
  updatedAt: z.date()
    .describe('When this subscription was last updated')
}).strict()
.refine(
...
export const paymentTransactionSchema = z.object({
  ...
  metadata: z.record(z.any())
    .optional()
    .describe('Additional metadata for the payment'),
  
  createdAt: z.date()
    .describe('When this payment was created')
}).strict()
...
export const featureUsageSchema = z.object({
  ...
  date: z.date()
    .describe('Date when the feature was used'),
  
  metadata: z.record(z.any())
    .optional()
    .describe('Additional metadata about the usage'),
  
  createdAt: z.date()
    .describe('When this usage record was created')
}).strict()
.refine(
