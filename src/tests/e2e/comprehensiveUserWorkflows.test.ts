...
test.describe('Comprehensive User Workflow Tests', () => {
  ...
  test.describe('Complete Business Search Workflow', () => {
    test('should complete full business search and export workflow', async ({ page }) => {
      ...
      workflowTester.addStep({
        ...
        action: async page => {
          await page.click(
            'a[href*="/search"], button:has-text("Start Search"), [data-testid="search-nav"]'
          )
        },
        validation: async page => {
      ...
      workflowTester.addStep({
        ...
        action: async page => {
          ...
          const industryInput = page
            .locator(
              'input[name="industry"], [data-testid="industry-input"], input[placeholder*="industry"]'
            )
            .first()
          ...
          const zipInput = page
            .locator(
              'input[name="zipCode"], [data-testid="zipcode-input"], input[placeholder*="zip"]'
            )
            .first()
          ...
          const maxResultsInput = page
            .locator('input[name="maxResults"], [data-testid="max-results"]')
            .first()
        ...
        validation: async page => {
          ...
          const industryValue = await page
            .locator('input[name="industry"], [data-testid="industry-input"]')
            .first()
            .inputValue()
            .catch(() => '')
          const zipValue = await page
      ...
      workflowTester.addStep({
        ...
        action: async page => {
          await page.click(
            'button[type="submit"], [data-testid="search-button"], button:has-text("Search")'
          )
        },
        validation: async page => {
      ...
      workflowTester.addStep({
        ...
        action: async page => {
          ...
          await Promise.race([
            page.waitForSelector('[data-testid="results-table"], .results-table, table', {
              timeout: 30000,
            }),
            page.waitForSelector('[data-testid="results-list"], .results-list', { timeout: 30000 }),
            page.waitForSelector('[data-testid="business-card"], .business-card', {
              timeout: 30000,
            }),
          ])
        },
      ...
      workflowTester.addStep({
        ...
        action: async page => {
          ...
          const sortButton = page
            .locator('[data-testid="sort-button"], button:has-text("Sort")')
            .first()
          ...
          const nextButton = page
            .locator('[data-testid="next-page"], button:has-text("Next")')
            .first()
      ...
      workflowTester.addStep({
        ...
        action: async page => {
          ...
          if (await exportButton.isVisible()) {
            ...
            const csvOption = page
              .locator('[data-testid="csv-option"], option[value="csv"], button:has-text("CSV")')
              .first()
        ...
        validation: async page => {
          ...
          await Promise.race([
            ...
            page.waitForSelector('[data-testid="export-success"], .success-message', {
              timeout: 5000,
            }),
          ]).catch(() => {
    ...
    test('should handle search with no results gracefully', async ({ page }) => {
      ...
      workflowTester.addStep({
        ...
        action: async page => {
          await page.fill(
            'input[name="industry"], [data-testid="industry-input"]',
            'nonexistentbusinesstype12345'
          )
        ...
        validation: async page => {
          ...
          await Promise.race([
            page.waitForSelector('[data-testid="no-results"], .no-results, .empty-state', {
              timeout: 30000,
            }),
    ...
    test('should handle network errors gracefully', async ({ page, context }) => {
      ...
      workflowTester.addStep({
        ...
        validation: async page => {
          ...
          await Promise.race([
            page.waitForSelector('[data-testid="error-message"], .error-message', {
              timeout: 10000,
            }),
      ...
      workflowTester.addStep({
        ...
        validation: async page => {
          ...
          const hasValidationError = await Promise.race([
            page
              .waitForSelector('[data-testid="validation-error"], .validation-error', {
                timeout: 5000,
              })
              .then(() => true),
  ...
  test.describe('Performance and Load Workflows', () => {
    test('should handle rapid user interactions', async ({ page }) => {
      ...
      await expect(
        page.locator('input[name="zipCode"], [data-testid="zipcode-input"]')
      ).toHaveValue('12344')
    }, 30000)
