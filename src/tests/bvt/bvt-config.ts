  ...
  categories: [
    {
      ...
      tests: [
        ...
        {
          name: 'login-workflow',
          description: 'Verify login functionality and CSRF endless loop fix (Issue #189)',
    ...
    },
    {
      ...
      tests: [
        ...
        },
        {
          ...
          description: 'Authentication regression checks including Issue #189 CSRF loop fix',
          testFunction: 'testAuthRegression',
          timeout: 15000,
          expectedDuration: 5000,
        },
        {
          name: 'streaming-connection-regression',
          description: 'Streaming connection regression checks for Issue #191 EventSource connection failures',
          testFunction: 'testStreamingConnectionRegression',
          timeout: 20000,
          expectedDuration: 8000,
          dependencies: ['api-heartbeat'],
        },
      ],
    },
    {
    ...
    },
    {
      ...
      tests: [
        ...
        {
          name: 'streaming-search-functionality',
          description: 'Streaming search functionality works (Issue #191 fix verification)',
          testFunction: 'testStreamingSearchFunctionality',
          timeout: 25000,
          expectedDuration: 8000,
          dependencies: ['api-heartbeat'],
        },
        ...
        },
        {
          ...
          description: 'Toast deduplication prevents duplicate notifications (Issue #194)',
          testFunction: 'testToastDeduplication',
          timeout: 10000,
          expectedDuration: 2000,
        },
        {
          name: 'streaming-fallback',
          description: 'Streaming connection fallback works when server unavailable (Issue #194)',
          testFunction: 'testStreamingFallback',
          timeout: 15000,
    ...
    },
    {
      ...
      tests: [
        ...
        {
          name: 'browser-pool-performance',
          description: 'Browser pool creates browsers within performance targets (Issue #204)',
          testFunction: 'testBrowserPoolPerformance',
          timeout: 25000,
          expectedDuration: 8000,
        },
        {
          name: 'cache-performance',
          description: 'Multi-level cache achieves >90% hit ratio (Issue #204)',
          testFunction: 'testCachePerformance',
          timeout: 15000,
          expectedDuration: 3000,
        },
        {
          name: 'streaming-performance',
          description: 'Streaming processor handles large datasets efficiently (Issue #204)',
          testFunction: 'testStreamingPerformance',
          timeout: 35000,
          expectedDuration: 12000,
        },
        {
          name: 'overall-performance-score',
          description: 'Overall performance score >70 (Issue #204)',
          testFunction: 'testOverallPerformanceScore',
          timeout: 20000,
