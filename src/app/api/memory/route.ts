        ...
        return NextResponse.json(
          {
            ...
            message:
              'Action must be one of: start-monitoring, stop-monitoring, cleanup, emergency-cleanup, update-thresholds, update-retention-policy, start-auto-cleanup, stop-auto-cleanup, force-gc',
          },
          { status: 400 }
        )
    }
