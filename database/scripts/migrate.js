...
function showStatus() {
    ...
    console.log();
    const result = psqlExec('SELECT version, name, status, applied_at, execution_time_ms FROM migration_status ORDER BY version;');
...
async function resetDatabase() {
    ...
    return new Promise((resolve) => {
        readline.question('This will drop all tables and reset the database. Are you sure? (y/N) ', (answer) => {
            readline.close();
